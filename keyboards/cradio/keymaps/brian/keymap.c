...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_DEL,  KC_4,    KC_5,    KC_6,    KC_VOLD,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_DELETE,
    KC_CAPS, KC_7,    KC_8,    KC_9,    KC_0,        KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______,
                               MO(3),   QK_GESC,     _______, KC_CAPS_LOCK
    ),
